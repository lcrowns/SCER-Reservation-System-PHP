  	...
  	<div class="form-group col-md-12">
  		<?php
			...
			<div class = "panel-body">
				...
				<a class = "btn btn-warning disabled"> Accepted</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `court` WHERE `IDnumber` = '$id1' && `status` = 'Accepted'") or die(mysqli_error());
						...
						<tr>
							...
							<td><center> 
								<a class = "btn btn-outline-danger" href = "cancelreason.php?transactionID=<?php echo $fetch['transactionID']?>"><i class = "glyphicon glyphicon-check"></i> Cancel Reservation</a>
