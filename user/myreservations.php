  	...
  	<div class="form-group col-md-12">
  		<?php
			...
			<div class = "panel-body">
				...
				<a class = "btn btn-info disabled"> Active</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `court` WHERE `IDnumber` = '$id1' && `status` = 'Check In'") or die(mysqli_error());
