...
$query = "SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `court` WHERE `IDnumber`= '$sd' AND `status` = 'Pending'";
...
$pdf->Cell(59,5, "List of Pending Transactions",0,1); //EOL
