  	...
  	<div style='margin-left:15px;margin-right:15px '>
  		<?php
			...
			<div class = "panel-body">
				<a class = "btn btn-success disabled"><span class = "badge"><?php echo $f_r['total']?></span> Requests</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `court` WHERE `status` = 'Pending' && `isRead` ='No'") or die(mysqli_error());
