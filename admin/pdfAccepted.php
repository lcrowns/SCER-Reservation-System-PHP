...
$query = "SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `court` WHERE `IDnumber`= '$sd' AND `status` ='Accepted'";
...
$pdf->Cell(59,5, "List of Accepted Transactions",0,1); //EOL
