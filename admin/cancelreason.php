...
<body>
	...
	<br>
  		...
  		<a href="reserve.php" style="margin-left: 15px"><span class="badge badge-pill badge-secondary">Back</span></a>
  		<hr class='my-4'>
			...
			<div class="card text-white bg-dark mb-3 border-success" style="max-width: 60em;">
					...
					<form method = "POST" enctype = "multipart/form-data">
						<h4 class="card-title">Reason for cancel:
							<input type = "text" class = "form-control" name = "cancelReason" style="width: 800px" required="" />
						</h4>
						
			         
						<div class = "col-md-12">
							<button name = "delete_pending" class = "btn btn-outline-info""> Submit</button>
							<a href="reserve.php"><button type="button" class="btn btn-outline-warning" data-dismiss="modal" >Back</button></a>
						</div>
					</form>
