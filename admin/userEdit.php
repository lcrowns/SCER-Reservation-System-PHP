...
<body>
  		...
  		<br>
  		<h2 style="margin-left: 15px">Update Client</h2>
  		<hr class='my-4'>
	...
	<div class = "container form-row">
		<div class="form-group col-md-12">
			<div class="card text-white bg-dark mb-3 border-success" style="max-width: 80em;">
					...
					<?php
						$query = $conn->query("SELECT * FROM `users` WHERE `IDnumber` = '$_REQUEST[IDnumber]'") or die(mysqli_error());
					...
					<div class = "col-md-12">
							<button name = "userEdit" class = "btn btn-outline-info" style="margin-left: 840px" href="user.php"> Save Changes</button>
							<a href="user.php"><button type="button" class="btn btn-outline-warning" data-dismiss="modal" >Back</button></a>
						</div>
					</form>
					<?php require_once 'userEditQuery.php' ?>
				</div>
			</div>
		</div>
	</div>
