  	...
  	<div style='margin-left:15px;margin-right:15px '>
        ...
        $f_co = $q_co->fetch_array();
			...
			<div class = "panel-body">
				<a class = "btn btn-success disabled"><span class = "badge"><?php echo $f_p['total']?></span> Pending</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><center>
								<a class = "btn btn-outline-primary" href = "accepted_query.php?transactionID=<?php echo $fetch['transactionID']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Accept</a>
								...
								<!--<a class = "btn btn-outline-danger" onclick = "confirmationDelete(); return false;" href = "delete_pending.php?transactionID=<?php echo $fetch['transactionID']?>"><i class = "glyphicon glyphicon-trash"></i> Decline</a></td>-->
						</tr>
						<?php
							}
						?>
