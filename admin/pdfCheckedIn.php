...
$query = "SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `court` WHERE `IDnumber`= '$sd' AND `status` ='Check In'";
...
$pdf->Cell(59,5, "List of Checked In Transactions",0,1); //EOL
